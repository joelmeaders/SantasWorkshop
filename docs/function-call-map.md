...
| firestore:tmp_registrationemails/{docId} | sendNewRegistrationEmails | onDocumentCreated | [santashop-functions/src/index.ts:446](../santashop-functions/src/index.ts#L446) |
...
| scheduledDateTimeSlotCounters | SCHEDULED_DATETIME_SLOT_COUNTERS | `*/5 * * 11,12 *` | `*/5 * * * *` | [santashop-functions/src/fn/reconcileAppointmentCounters.ts](../santashop-functions/src/fn/reconcileAppointmentCounters.ts) |
...
emailIsolationProbe is a private operator HTTP endpoint. It has no app caller and probes external AWS email connectivity. requestPasswordReset and callableSendTestEmailTemplate send mail directly through local helpers; they do not queue registration emails or call the registration trigger. Auth, Storage, SES, Remote Config, and Firestore export APIs are external sinks in this function graph.
...
| --- | --- | --- | --- | --- |
| emailIsolationProbe | onRequest | No app call found | [santashop-functions/src/fn/emailIsolationProbe.ts](../santashop-functions/src/fn/emailIsolationProbe.ts) | [santashop-functions/src/index.ts:136](../santashop-functions/src/index.ts#L136) |
| publicParametersGateway | onRequest | No app call found | [santashop-functions/src/fn/publicParametersGateway.ts](../santashop-functions/src/fn/publicParametersGateway.ts) | [santashop-functions/src/index.ts:160](../santashop-functions/src/index.ts#L160) |
| changeAccountInformation | onCall | santashop-app, santashop-core | [santashop-functions/src/fn/changeAccountInformation.ts](../santashop-functions/src/fn/changeAccountInformation.ts) | [santashop-functions/src/index.ts:174](../santashop-functions/src/index.ts#L174) |
| completeRegistration | onCall | santashop-app, santashop-core | [santashop-functions/src/fn/completeRegistration.ts](../santashop-functions/src/fn/completeRegistration.ts) | [santashop-functions/src/index.ts:189](../santashop-functions/src/index.ts#L189) |
| saveDraftChild | onCall | santashop-app, santashop-core | [santashop-functions/src/fn/saveDraftChild.ts](../santashop-functions/src/fn/saveDraftChild.ts) | [santashop-functions/src/index.ts:196](../santashop-functions/src/index.ts#L196) |
| deleteDraftChild | onCall | santashop-app, santashop-core | [santashop-functions/src/fn/deleteDraftChild.ts](../santashop-functions/src/fn/deleteDraftChild.ts) | [santashop-functions/src/index.ts:203](../santashop-functions/src/index.ts#L203) |
| setDraftAppointment | onCall | santashop-app, santashop-core | [santashop-functions/src/fn/setDraftAppointment.ts](../santashop-functions/src/fn/setDraftAppointment.ts) | [santashop-functions/src/index.ts:210](../santashop-functions/src/index.ts#L210) |
| newAccount | onCall | santashop-app | [santashop-functions/src/fn/newAccount.ts](../santashop-functions/src/fn/newAccount.ts) | [santashop-functions/src/index.ts:217](../santashop-functions/src/index.ts#L217) |
| undoRegistration | onCall | santashop-admin, santashop-app, santashop-core | [santashop-functions/src/fn/undoRegistration.ts](../santashop-functions/src/fn/undoRegistration.ts) | [santashop-functions/src/index.ts:224](../santashop-functions/src/index.ts#L224) |
| changeRegistrationDateTime | onCall | santashop-admin, santashop-app, santashop-core | [santashop-functions/src/fn/changeRegistrationDateTime.ts](../santashop-functions/src/fn/changeRegistrationDateTime.ts) | [santashop-functions/src/index.ts:231](../santashop-functions/src/index.ts#L231) |
| updateEmailAddress | onCall | santashop-core | [santashop-functions/src/fn/updateEmailAddress.ts](../santashop-functions/src/fn/updateEmailAddress.ts) | [santashop-functions/src/index.ts:240](../santashop-functions/src/index.ts#L240) |
| checkIn | onCall | santashop-admin | [santashop-functions/src/fn/checkIn.ts](../santashop-functions/src/fn/checkIn.ts) | [santashop-functions/src/index.ts:247](../santashop-functions/src/index.ts#L247) |
| resolveRegistrationScan | onCall | santashop-admin | [santashop-functions/src/fn/resolveRegistrationScan.ts](../santashop-functions/src/fn/resolveRegistrationScan.ts) | [santashop-functions/src/index.ts:254](../santashop-functions/src/index.ts#L254) |
| checkInWithEdit | onCall | santashop-admin | [santashop-functions/src/fn/checkInWithEdit.ts](../santashop-functions/src/fn/checkInWithEdit.ts) | [santashop-functions/src/index.ts:261](../santashop-functions/src/index.ts#L261) |
| onSiteRegistration | onCall | santashop-admin | [santashop-functions/src/fn/onSiteRegistration.ts](../santashop-functions/src/fn/onSiteRegistration.ts) | [santashop-functions/src/index.ts:268](../santashop-functions/src/index.ts#L268) |
| callableAdminPreRegister | onCall | santashop-admin | [santashop-functions/src/fn/callableAdminPreRegister.ts](../santashop-functions/src/fn/callableAdminPreRegister.ts) | [santashop-functions/src/index.ts:275](../santashop-functions/src/index.ts#L275) |
| callableResendRegistrationEmail | onCall | santashop-admin | [santashop-functions/src/fn/callableResendRegistrationEmail.ts](../santashop-functions/src/fn/callableResendRegistrationEmail.ts) | [santashop-functions/src/index.ts:282](../santashop-functions/src/index.ts#L282) |
| callableListEmailTemplates | onCall | santashop-admin | [santashop-functions/src/fn/callableListEmailTemplates.ts](../santashop-functions/src/fn/callableListEmailTemplates.ts) | [santashop-functions/src/index.ts:294](../santashop-functions/src/index.ts#L294) |
| callableGetEmailTemplate | onCall | santashop-admin | [santashop-functions/src/fn/callableGetEmailTemplate.ts](../santashop-functions/src/fn/callableGetEmailTemplate.ts) | [santashop-functions/src/index.ts:303](../santashop-functions/src/index.ts#L303) |
| callableGetEmailTemplateRevision | onCall | santashop-admin | [santashop-functions/src/fn/callableGetEmailTemplateRevision.ts](../santashop-functions/src/fn/callableGetEmailTemplateRevision.ts) | [santashop-functions/src/index.ts:310](../santashop-functions/src/index.ts#L310) |
| callableSaveEmailTemplateRevision | onCall | santashop-admin | [santashop-functions/src/fn/callableSaveEmailTemplateRevision.ts](../santashop-functions/src/fn/callableSaveEmailTemplateRevision.ts) | [santashop-functions/src/index.ts:322](../santashop-functions/src/index.ts#L322) |
| callableDeleteEmailTemplate | onCall | santashop-admin | [santashop-functions/src/fn/callableDeleteEmailTemplate.ts](../santashop-functions/src/fn/callableDeleteEmailTemplate.ts) | [santashop-functions/src/index.ts:334](../santashop-functions/src/index.ts#L334) |
| callablePublishEmailTemplate | onCall | santashop-admin | [santashop-functions/src/fn/callablePublishEmailTemplate.ts](../santashop-functions/src/fn/callablePublishEmailTemplate.ts) | [santashop-functions/src/index.ts:343](../santashop-functions/src/index.ts#L343) |
| callableSendTestEmailTemplate | onCall | santashop-admin | [santashop-functions/src/fn/callableSendTestEmailTemplate.ts](../santashop-functions/src/fn/callableSendTestEmailTemplate.ts) | [santashop-functions/src/index.ts:352](../santashop-functions/src/index.ts#L352) |
| callableCreateStaffUser | onCall | santashop-admin | [santashop-functions/src/fn/callableCreateStaffUser.ts](../santashop-functions/src/fn/callableCreateStaffUser.ts) | [santashop-functions/src/index.ts:361](../santashop-functions/src/index.ts#L361) |
| callableUpdateStaffUser | onCall | santashop-admin | [santashop-functions/src/fn/callableUpdateStaffUser.ts](../santashop-functions/src/fn/callableUpdateStaffUser.ts) | [santashop-functions/src/index.ts:368](../santashop-functions/src/index.ts#L368) |
| callableDeleteStaffUser | onCall | santashop-admin | [santashop-functions/src/fn/callableDeleteStaffUser.ts](../santashop-functions/src/fn/callableDeleteStaffUser.ts) | [santashop-functions/src/index.ts:375](../santashop-functions/src/index.ts#L375) |
| callablePreviewOwnerOperation | onCall | santashop-admin | [santashop-functions/src/fn/ownerOperations.ts](../santashop-functions/src/fn/ownerOperations.ts) | [santashop-functions/src/index.ts:382](../santashop-functions/src/index.ts#L382) |
| callableStartOwnerOperation | onCall | santashop-admin | [santashop-functions/src/fn/ownerOperations.ts](../santashop-functions/src/fn/ownerOperations.ts) | [santashop-functions/src/index.ts:391](../santashop-functions/src/index.ts#L391) |
| callableGetOwnerOperation | onCall | santashop-admin | [santashop-functions/src/fn/ownerOperations.ts](../santashop-functions/src/fn/ownerOperations.ts) | [santashop-functions/src/index.ts:400](../santashop-functions/src/index.ts#L400) |
| callableGetOwnerExportUrl | onCall | santashop-admin | [santashop-functions/src/fn/ownerOperations.ts](../santashop-functions/src/fn/ownerOperations.ts) | [santashop-functions/src/index.ts:409](../santashop-functions/src/index.ts#L409) |
| ownerOperationWorker | onTaskDispatched | No app call found | [santashop-functions/src/fn/ownerOperationWorker.ts](../santashop-functions/src/fn/ownerOperationWorker.ts) | [santashop-functions/src/index.ts:418](../santashop-functions/src/index.ts#L418) |
| sendNewRegistrationEmails | onDocumentCreated | No app call found | [santashop-functions/src/fn/sendRegistrationEmail.ts](../santashop-functions/src/fn/sendRegistrationEmail.ts) | [santashop-functions/src/index.ts:446](../santashop-functions/src/index.ts#L446) |
| scheduledFirestoreBackup | onSchedule | No app call found | [santashop-functions/src/fn/scheduledFirestoreBackup.ts](../santashop-functions/src/fn/scheduledFirestoreBackup.ts) | [santashop-functions/src/index.ts:482](../santashop-functions/src/index.ts#L482) |
| scheduledDateTimeSlotCounters | onSchedule | No app call found | [santashop-functions/src/fn/reconcileAppointmentCounters.ts](../santashop-functions/src/fn/reconcileAppointmentCounters.ts) | [santashop-functions/src/index.ts:499](../santashop-functions/src/index.ts#L499) |
| scheduledRegistrationStats | onSchedule | No app call found | [santashop-functions/src/fn/scheduledRegistrationStats.ts](../santashop-functions/src/fn/scheduledRegistrationStats.ts) | [santashop-functions/src/index.ts:517](../santashop-functions/src/index.ts#L517) |
| scheduledUserStats | onSchedule | No app call found | [santashop-functions/src/fn/scheduledUserStats.ts](../santashop-functions/src/fn/scheduledUserStats.ts) | [santashop-functions/src/index.ts:534](../santashop-functions/src/index.ts#L534) |
| scheduledCheckInStats | onSchedule | No app call found | [santashop-functions/src/fn/scheduledCheckInStats.ts](../santashop-functions/src/fn/scheduledCheckInStats.ts) | [santashop-functions/src/index.ts:551](../santashop-functions/src/index.ts#L551) |
| updatePreferredLanguage | onCall | santashop-app | [santashop-functions/src/fn/updatePreferredLanguage.ts](../santashop-functions/src/fn/updatePreferredLanguage.ts) | [santashop-functions/src/index.ts:567](../santashop-functions/src/index.ts#L567) |
| requestPasswordReset | onCall | santashop-core | [santashop-functions/src/fn/requestPasswordReset.ts](../santashop-functions/src/fn/requestPasswordReset.ts) | [santashop-functions/src/index.ts:576](../santashop-functions/src/index.ts#L576) |
| readPublicParametersSettings | onCall | santashop-admin | [santashop-functions/src/fn/publicParametersSettings.ts](../santashop-functions/src/fn/publicParametersSettings.ts) | [santashop-functions/src/index.ts:583](../santashop-functions/src/index.ts#L583) |
| publishPublicParametersSettings | onCall | santashop-admin | [santashop-functions/src/fn/publicParametersSettings.ts](../santashop-functions/src/fn/publicParametersSettings.ts) | [santashop-functions/src/index.ts:591](../santashop-functions/src/index.ts#L591) |
| testSeedScenario | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:629](../santashop-functions/src/index.ts#L629) |
| testSeedPublicParameters | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:654](../santashop-functions/src/index.ts#L654) |
| testClearAllData | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:676](../santashop-functions/src/index.ts#L676) |
| testSeedAdminUser | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:693](../santashop-functions/src/index.ts#L693) |
| testSeedDateTimeSlots | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:750](../santashop-functions/src/index.ts#L750) |
| testSeedRegistrationSearchIndex | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:782](../santashop-functions/src/index.ts#L782) |
| testSeedRegistration | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:817](../santashop-functions/src/index.ts#L817) |
| testInspectRegistrationQrLifecycle | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:838](../santashop-functions/src/index.ts#L838) |
| testInspectRegistrationScanAudit | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:867](../santashop-functions/src/index.ts#L867) |
| testInspectQueuedRegistrationEmails | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:896](../santashop-functions/src/index.ts#L896) |
| testSeedScanRiskHistory | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:925](../santashop-functions/src/index.ts#L925) |
| testSeedScheduleStats | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:949](../santashop-functions/src/index.ts#L949) |
| testSeedReportingStats | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:986](../santashop-functions/src/index.ts#L986) |
| testSeedCheckIn | onCall (emulator only) | No app call found | [santashop-functions/src/fn/testHelpers.ts](../santashop-functions/src/fn/testHelpers.ts) | [santashop-functions/src/index.ts:1033](../santashop-functions/src/index.ts#L1033) |
| testReadPublicParameters | onCall (emulator only) | santashop-admin, santashop-app | [santashop-functions/src/utility/public-parameters.ts](../santashop-functions/src/utility/public-parameters.ts) | [santashop-functions/src/index.ts:1056](../santashop-functions/src/index.ts#L1056) |
