...
import {
    AlertController,
    LoadingController,
    ModalController, IonContent, IonList, IonListHeader, IonNote, IonItemDivider, IonLabel, IonItem, IonInput, IonCheckbox, IonButton, IonIcon, IonText, IonSelect, IonSelectOption
