...
@Component({
    ...
    standalone: true,
    imports: [HeaderComponent, ReactiveFormsModule, NgIf, RouterLink, IonRouterLink, IonContent, IonCardHeader, IonCardTitle, IonCardSubtitle, IonList, IonItem, IonLabel, IonInput, IonNote, IonButton, IonIcon],
})
