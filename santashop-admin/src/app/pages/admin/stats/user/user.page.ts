...
import { IonContent, IonGrid, IonRow, IonCol, IonToolbar, IonTitle } from "@ionic/angular/standalone";
...
@Component({
    ...
    standalone: true,
    imports: [HeaderComponent, NgIf, BaseChartDirective, AsyncPipe, IonContent, IonGrid, IonRow, IonCol, IonToolbar, IonTitle],
})
