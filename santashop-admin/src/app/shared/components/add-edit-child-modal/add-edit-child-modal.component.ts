...
@Component({
    ...
    standalone: true,
    imports: [NgIf, ReactiveFormsModule, AsyncPipe, IonHeader, IonToolbar, IonTitle, IonButton, IonContent, IonList, IonListHeader, IonNote, IonItemDivider, IonLabel, IonItem, IonInput, IonRadioGroup, IonRadio],
})
