...
import { AlertController, ModalController, IonItemDivider, IonLabel, IonBadge, IonButton, IonIcon, IonItem, IonNote, IonItemSliding, IonItemOptions, IonItemOption } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, NgFor, DatePipe, IonItemDivider, IonLabel, IonBadge, IonButton, IonIcon, IonItem, IonNote, IonItemSliding, IonItemOptions, IonItemOption],
})
