...
import { ModalController, IonHeader, IonToolbar, IonTitle, IonButton, IonContent, IonList, IonSearchbar, IonItemGroup, IonItemDivider, IonLabel, IonItem, IonInput } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, NgFor, AsyncPipe, IonHeader, IonToolbar, IonTitle, IonButton, IonContent, IonList, IonSearchbar, IonItemGroup, IonItemDivider, IonLabel, IonItem, IonInput],
})
