...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./features/v2/pre-registration/pre-registration.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./features/registration-closed/registration-closed.module').then(
        (m) => m.RegistrationClosedPageModule
      ),
  },
  {
    path: 'maintenance',
