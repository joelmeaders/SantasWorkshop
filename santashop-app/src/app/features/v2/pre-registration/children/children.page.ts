...
import { AlertController, IonContent, IonGrid, IonRow, IonCol, IonButton, IonIcon, IonItem, IonCardTitle, IonList, IonLabel, IonCardHeader, IonText, IonCardSubtitle } from '@ionic/angular/standalone';
...
import { arrowBackSharp, addCircle, manOutline, womanOutline, happyOutline, alertCircle, createOutline, trashOutline } from "ionicons/icons";
...
export class ChildrenPage {
    ...
    constructor(
        ...
        addIcons({ arrowBackSharp, addCircle, manOutline, womanOutline, happyOutline, alertCircle, createOutline, trashOutline });
    }
