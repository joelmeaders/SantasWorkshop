...
import { AlertController, ModalController, IonContent, IonGrid, IonRow, IonCol, IonButton, IonIcon, IonLabel, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonList, IonItemGroup, IonItemDivider, IonItem, IonInput, IonNote, IonText, IonCheckbox } from '@ionic/angular/standalone';
