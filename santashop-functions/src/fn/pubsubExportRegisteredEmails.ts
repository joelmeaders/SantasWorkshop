...
export default async function pubsubExportRegisteredEmails(): Promise<string> {
	...
	// csv field headers
	const fields = ['emailAddress', 'firstName', 'lastName', 'zipCode'];
	...
	const filename = `registeredCustomerEmailList_${dateTime}.csv`;
