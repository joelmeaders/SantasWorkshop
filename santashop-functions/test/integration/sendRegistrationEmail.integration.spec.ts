...
describe.sequential('sendRegistrationEmail integration', () => {
	beforeEach(async () => {
		...
		await setDocument(COLLECTION_SCHEMA.emailTemplates, 'confirmation', { key: 'confirmation', awsTemplateName: 'confirmation-published', publishedRevisionId: 'revision-1', fieldMappings: [] });
	});
