...
describe('sendRegistrationEmail handler', () => {
	...
	beforeEach(() => {
		...
		backgroundMock.setDocSnapshot('emailTemplates/confirmation', { key: 'confirmation', awsTemplateName: 'confirmation-published', publishedRevisionId: 'revision-1', fieldMappings: [] });
